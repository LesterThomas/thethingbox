...
<div class="navbar navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
			...
			<a class="brand"><img src="bee.png"></a> 
				<a class="brand" target="_blank" href="http://thethingbox.io"><span class="red">The ThingBox </span> </a> 
			
			<a class="brand" ><span class="red"> powered by </span> </a> 
			
            <a class="brand" ><img src="node-red.png"> </a>
				<a class="brand" target="_blank" href="http://nodered.org"><span class="red">Node-RED</span> </a>
            ...
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu">
					...
					<li class="divider"></li>
					<li><a id="btn-console" target="_blank" href="console.txt"><i class="icon-list"></i> Console</a></li>
					<li class="divider"></li>
					<li><a id="btn-settings" target="_blank" href="/api/form/settings"><i class="icon-cog"></i> Settings</a></li>
					<li class="divider"></li>
...
<script>
    $("#ttb-name").load("/api/form/current-hostname");
</script>
